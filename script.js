document.addEventListener("DOMContentLoaded", () => {
    ...
    const userIp = "123.45.67.89"; // Example user IP (replace this with dynamic fetching)
    const adminIp = "123.45.67.89"; // Example admin IP (this should be the IP of the admin)
